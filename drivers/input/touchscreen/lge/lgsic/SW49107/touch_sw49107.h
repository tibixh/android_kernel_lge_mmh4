...
#define TC_STATUS_NORMAL_MASK		0x0F5580E7	/* (1<<06)|(1<<07)|(0<<09)|(0<<10)|(0<<13)|
							   (1<<15)|(1<<20)|(0<<21)|(1<<22)|(0<<31) */
#define TC_STATUS_GLOBAL_RESET_BIT	0x80000600	/* (1<<09)|(1<<10)|(1<<31) */
