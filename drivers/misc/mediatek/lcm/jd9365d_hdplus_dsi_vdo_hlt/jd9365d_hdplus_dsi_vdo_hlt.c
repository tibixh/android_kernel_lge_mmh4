...
static struct LCM_setting_table_V3 lcm_initial_setting_CE_Digital_gamma[] = {
	{0x15, 0x55, 1,{0x80}},
...
static void init_lcm_registers_sleep_out(void)
{
    ...
    dsi_set_cmdq_V3(lcm_initial_setting_CE_Digital_gamma, sizeof(lcm_initial_setting_CE_Digital_gamma) / sizeof(struct LCM_setting_table_V3), 1);
