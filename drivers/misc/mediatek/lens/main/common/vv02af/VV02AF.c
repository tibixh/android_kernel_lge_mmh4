...
/*
 * VV02AF voice coil motor driver
 *
 *
 */
...
/* ////////////////////////////////////////////////////////////// */
long VV02AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int VV02AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
/*LGE_CHANGE_S, 2019-04-22, To fix tick noise of VCM , soojong.jin@lge.com*/
		...
		g_SR = 3; //restore slew rate
/*LGE_CHANGE_E, 2019-04-22, To fix tick noise of VCM , soojong.jin@lge.com*/
#endif
	}
...
int VV02AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int VV02AF_GetFileName(unsigned char *pFileName)
{
