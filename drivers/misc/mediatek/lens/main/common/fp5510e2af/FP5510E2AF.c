...
static void s4AF_esc_mode(void)
{
		...
		if (0x30C6 == mSensorid) {//s5k3l6
			s4AF_WriteReg_Directly(0xF240);

		}else if (0x3109 == mSensorid) {//s5k3p9
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		char puSendCmd5[2] = {(char)(0xF2), (char)(0x10)};
	...
	if (0x30C6 == mSensorid || 0x3109 == mSensorid)
		s4AF_esc_mode();
...
//+ HQ ADD The program of the motor hitting the base 20190606
static int s4AF_esc_mode_power_off(void)
{
    ...
    s4AF_WriteReg_Directly(0xDC51);
    s4AF_WriteReg_Directly(0x12C0);    // 0x12C0 back step 300 position 0x15E0:350
	mdelay(20);
    s4AF_WriteReg_Directly(0xECA3);
...
#else
		s4AF_esc_mode_power_off();   // HQ ADD The program of the motor hitting the base 20190513
		mdelay(100);
#endif
	}
