...
char *otp_content[] = {"AWB_5100K", "AWB_3000K", "AF", "LSC_5100K", "LSC_4000K"};
kal_uint16 m290_otp_read(otp_format_t *p, u16 i2c_addr, enum OTP_FORM otp_form, UINT8* data_c, u8 check)
{
...
void m290_get_fusion_id(u8 addr, u8 size,UINT8* fusion_id, u16 i2c_addr);
void m290_get_fusion_id(u8 addr, u8 size,UINT8* fusion_id, u16 i2c_addr)
{
	extern int iReadRegI2C(u8 *a_pSendData, u16 a_sizeSendData, u8 *a_pRecvData, u16 a_sizeRecvData, u16 i2cId);
	//UINT8 fusion_id[20];
	char pu_send_cmd[2] = {(char)(addr >> 8) , (char)(addr & 0xFF)};
    iReadRegI2C(pu_send_cmd , 2, (u8*)fusion_id, size, i2c_addr);
}
