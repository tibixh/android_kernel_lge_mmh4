...
static kal_uint32 open(void)
{
	...
	LOG_INF("[open]: PLATFORM:MT6762,MIPI 2LANE\n");
	LOG_INF("preview 1632*122430fps,720Mbps/lane;"
		"capture 3264*2448@30fps,1440Mbps/lane\n");
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		spin_lock(&imgsensor_drv_lock);
		imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
		spin_unlock(&imgsensor_drv_lock);
...
//Reallocation is required in the HAL.
	...
	{
		*((MUINT32 *)(feature_data)) = (0x46)<<16 | (0x46);     //16:9 = 70, 4:3 = 70 // (70)<<16 | (70)   Hor
		*(((MUINT32 *)(feature_data))+1) = (0x26)<<16 | (0x26); //16:9 = 38, 4:3 = 38 // (38)<<16 | (38)  Ver
