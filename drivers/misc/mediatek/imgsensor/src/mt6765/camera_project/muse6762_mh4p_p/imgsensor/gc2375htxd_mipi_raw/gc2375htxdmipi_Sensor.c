...
#include "gc2375htxdmipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "gc2375htxd_camera_sensor"
#define LOG_1 LOG_INF("GC2375HTXD, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
kal_bool GC2375HTXDDuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = (GC2375HTXD_SENSOR_ID - 0x1), /* record sensor id defined in Kd_imgsensor.h */
	.checksum_value = 0x8726c936,   //0xf7375923 /* checksum value for Camera Auto Test */
...
#if defined(GC2375HTXDMIPI_USE_OTP)
static struct gc2375htxd_otp gc2375htxd_otp_info;

static kal_uint8 gc2375htxd_read_otp(kal_uint8 addr)
{
	kal_uint8 value;
...
static void gc2375htxd_gcore_read_otp_info(void)
{
	kal_uint8 flag;

	memset(&gc2375htxd_otp_info, 0, sizeof(gc2375htxd_otp_info));

	flag = gc2375htxd_read_otp(0x00);
	LOG_DEBUG("GC2375HTXD_OTP: flag = 0x%x\n", flag);

	gc2375htxd_otp_info.wb_flag = flag & 0x03;
	gc2375htxd_otp_info.ob_flag = (flag >> 2) & 0x03;

	/* WB */
	if (0x01 == gc2375htxd_otp_info.wb_flag) {
		LOG_DEBUG("GC2375HTXD_OTP_WB: Valid");

		gc2375htxd_otp_info.r_gain = gc2375htxd_read_otp(0x08);
		gc2375htxd_otp_info.g_gain = gc2375htxd_read_otp(0x10);
		gc2375htxd_otp_info.b_gain = gc2375htxd_read_otp(0x18);
		gc2375htxd_otp_info.g_r_gain_l = gc2375htxd_read_otp(0x20);
		gc2375htxd_otp_info.b_g_gain_l = gc2375htxd_read_otp(0x28);

		LOG_INF("GC2375HTXD_OTP_WB: r_gain = 0x%x\n", gc2375htxd_otp_info.r_gain);
		LOG_INF("GC2375HTXD_OTP_WB: g_gain = 0x%x\n", gc2375htxd_otp_info.g_gain);
		LOG_INF("GC2375HTXD_OTP_WB: b_gain = 0x%x\n", gc2375htxd_otp_info.b_gain);
		LOG_INF("GC2375HTXD_OTP_WB: g_r_gain_l = 0x%x\n", gc2375htxd_otp_info.g_r_gain_l);
		LOG_INF("GC2375HTXD_OTP_WB: b_g_gain_l = 0x%x\n", gc2375htxd_otp_info.b_g_gain_l);
	} else {
		LOG_DEBUG("GC2375HTXD_OTP_WB: Invalid!");
	}

	/* OB */
	if (0x01 == gc2375htxd_otp_info.ob_flag) {
		LOG_DEBUG("GC2375HTXD_OTP_OB:Valid");

		gc2375htxd_otp_info.g1_slope = gc2375htxd_read_otp(0x30);
		gc2375htxd_otp_info.r1_slope = gc2375htxd_read_otp(0x38);
		gc2375htxd_otp_info.b2_slope = gc2375htxd_read_otp(0x40);
		gc2375htxd_otp_info.g2_slope = gc2375htxd_read_otp(0x48);
		gc2375htxd_otp_info.ob_slope = gc2375htxd_read_otp(0x50);

		LOG_INF("GC2375HTXD_OTP_OB: g1_slope = 0x%x\n", gc2375htxd_otp_info.g1_slope);
		LOG_INF("GC2375HTXD_OTP_OB: r1_slope = 0x%x\n", gc2375htxd_otp_info.r1_slope);
		LOG_INF("GC2375HTXD_OTP_OB: b2_slope = 0x%x\n", gc2375htxd_otp_info.b2_slope);
		LOG_INF("GC2375HTXD_OTP_OB: g2_slope = 0x%x\n", gc2375htxd_otp_info.g2_slope);
		LOG_INF("GC2375HTXD_OTP_OB: ob_slope = 0x%x\n", gc2375htxd_otp_info.ob_slope);
	} else {
		LOG_DEBUG("GC2375HTXD_OTP_OB:Invalid!");
	}
}

static void gc2375htxd_gcore_update_wb(void)
{
	if (0x01 == gc2375htxd_otp_info.wb_flag) {
		write_cmos_sensor(0xfe, 0x00);
		write_cmos_sensor(0xb8, gc2375htxd_otp_info.g_gain);
		write_cmos_sensor(0xb9, gc2375htxd_otp_info.r_gain);
		write_cmos_sensor(0xba, gc2375htxd_otp_info.b_gain);
		write_cmos_sensor(0xbb, gc2375htxd_otp_info.g_gain);
		write_cmos_sensor(0xbe, gc2375htxd_otp_info.g_r_gain_l);
		write_cmos_sensor(0xbf, gc2375htxd_otp_info.b_g_gain_l);
		write_cmos_sensor(0xfe, 0x00);
	}
}

static void gc2375htxd_gcore_update_ob(void)
{
	if (0x01 == gc2375htxd_otp_info.ob_flag) {
		write_cmos_sensor(0xfe, 0x01);
		write_cmos_sensor(0x41, gc2375htxd_otp_info.g1_slope);
		write_cmos_sensor(0x42, gc2375htxd_otp_info.r1_slope);
		write_cmos_sensor(0x43, gc2375htxd_otp_info.b2_slope);
		write_cmos_sensor(0x44, gc2375htxd_otp_info.g2_slope);
		write_cmos_sensor(0x45, gc2375htxd_otp_info.ob_slope);
		write_cmos_sensor(0xfe, 0x00);
	}
}

static void gc2375htxd_gcore_update_otp(void)
{
	gc2375htxd_gcore_update_wb();
	gc2375htxd_gcore_update_ob();
}

static void gc2375htxd_gcore_enable_otp(kal_uint8 state)
{
	...
	if (state) {
		...
		LOG_DEBUG("GC2375HTXD_OTP: Enable OTP!\n");
	} else {
		otp_en = otp_en & 0x7f;
		...
		LOG_DEBUG("GC2375HTXD_OTP: Disable OTP!\n");
	}
}

void gc2375htxd_gcore_identify_otp(void)
{
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xfe, 0x00);
	...
	gc2375htxd_gcore_enable_otp(otp_open);
	gc2375htxd_gcore_read_otp_info();
	gc2375htxd_gcore_enable_otp(otp_close);
}
#endif
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if ((ANALOG_GAIN_1 <= iReg) && (iReg < ANALOG_GAIN_2)) {
		...
		LOG_INF("GC2375HTXDMIPI analogic gain 1x, GC2375HTXDMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375HTXDMIPI analogic gain 1.43x , GC2375HTXDMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375HTXDMIPI analogic gain 2x , GC2375HTXDMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375HTXDMIPI analogic gain 2.84x , GC2375HTXDMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375HTXDMIPI analogic gain 3.97x , GC2375HTXDMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375HTXDMIPI analogic gain 5.68x , GC2375HTXDMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375HTXDMIPI analogic gain 8.14x , GC2375HTXDMIPI add pregain = %d\n", temp);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375HTXDMIPI analogic gain 11.34x , GC2375HTXDMIPI add pregain = %d\n", temp);
	} else {
		write_cmos_sensor(0x20, 0x0c);
		write_cmos_sensor(0x22, 0x0e);
		write_cmos_sensor(0x26, 0x0e);
		...
		write_cmos_sensor(0xb1, temp >> 6);
		write_cmos_sensor(0xb2, (temp << 2) & 0xfc);
		LOG_INF("GC2375HTXDMIPI analogic gain 16.23x , GC2375HTXDMIPI add pregain = %d\n", temp);
	}
	return gain;
}
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x17, GC2375HTXD_MIRROR);
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
                strcpy(aux_sensor_name, "gc2375h_tsp");/*LGE_CHANGE, 2019-07-04, add the camera identifying logic , kyunghun.oh@lge.com*/
...
static kal_uint32 open(void)
{
...
#ifdef GC2375HTXDMIPI_USE_OTP
	gc2375htxd_gcore_identify_otp();
#endif
	...
	spin_unlock(&imgsensor_drv_lock);
	GC2375HTXDDuringTestPattern = KAL_FALSE;
...
{
	LOG_INF("E\n");
    printk("[gc2375] custom2 mode start\n");
	spin_lock(&imgsensor_drv_lock);
