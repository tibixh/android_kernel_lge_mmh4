...
static struct imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		...
		.framelength = 3359,//3300, 			//record different mode's framelength
...
#if 0
	{ 4240, 3124,   0,   0, 4240, 3124,	 2120, 1562,  16, 2, 2104, 1560, 4, 4, 2096, 1552},		// preview (2104 x 1560)//DIFF
	{ 4240, 3124,   0,   0, 4240, 3124,	 4240, 3124,  16, 2, 4208, 3120, 8, 8, 4192, 3104},		// capture (4208 x 3120)
	{ 4240, 3124,   0,   0, 4240, 3124,	 4240, 3124,  16, 2, 4208, 3120, 8, 8, 4192, 3104},		// VIDEO (4208 x 3120)
	{ 4240, 3124,   0, 110, 4240, 2904,	  704,  484,  34, 2,  640,  480, 0, 0,  640,  480},		// hight speed video (640 x 480)
 	{ 4240, 3124,   0, 476, 4240, 2172,  1408,  724,  66, 2, 1280,  720, 0, 0, 1280,  720},       // slim video (1280 x 720)
#endif
...
static void set_dummy(void)
{
	...
	//if(pip_mode)
	//	write_cmos_sensor(0x0008, imgsensor.line_length / 4);//DIFF
	//else
...
static void write_shutter(kal_uint32 shutter)
{
	...
	if (imgsensor.autoflicker_en) {
		...
		// ADD ODIN
		//realtime_fps = imgsensor.pclk * 10 /
		//	(imgsensor.line_length * imgsensor.frame_length);//DIFF
