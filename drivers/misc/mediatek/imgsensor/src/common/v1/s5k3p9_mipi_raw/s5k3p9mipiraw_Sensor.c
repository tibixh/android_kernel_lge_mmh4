...
{
	kal_uint16 read_count = 0;
        kal_uint16 read_register0005_value = 0;
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  write_cmos_sensor(0x0312, 0x0001);
  write_cmos_sensor(0x0340, 0x0E44);
  write_cmos_sensor(0x0342, 0x27E0);
  write_cmos_sensor(0x0202, 0x0100);
  write_cmos_sensor(0x0200, 0x0100);
  write_cmos_sensor(0x021E, 0x0000);
  write_cmos_sensor(0x0D00, 0x0100);
...
#endif
		pr_err("[s5k3p9]i2c write id: 0x%x, ReadOut sensor id: 0x%x, imgsensor_info.sensor_id:0x%x.\n", imgsensor.i2c_write_id, *sensor_id, imgsensor_info.sensor_id);
		return ERROR_NONE;
	    }
