...
#include "gc8034backmipi_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC8034BACK_SENSOR_ID,       /*record sensor id defined in Kd_imgsensor.h*/
...
#ifdef GC8034_LY_EEPROM
static kal_uint16 read_eeprom(kal_uint32 addr)
{
	kal_uint16 get_byte=0;

	char pu_send_cmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
	iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 1, EEPROM_LY_GC8034_ID);
