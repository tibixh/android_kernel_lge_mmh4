...
struct s5k4h7_otp_data_str {
	kal_uint8 supplier_code;	//TSP:0x56
	kal_uint8 module_code;		//AL1680:0x13
	kal_uint8 len_id;
	kal_uint8 ir_id;
	kal_uint8 module_version;
	kal_uint8 software_version;
	kal_uint8 calibration_station;
	kal_uint8 year;
	kal_uint8 month;
	kal_uint8 day;
	...
	kal_uint8 Gr_over_Gb_unit_h;
	kal_uint8 Gr_over_Gb_unit_l;
	kal_uint8 R_over_G_golden_h;
	kal_uint8 R_over_G_golden_l;
	kal_uint8 B_over_G_golden_h;
	kal_uint8 B_over_G_golden_l;
	kal_uint8 Gr_over_Gb_golden_h;
	kal_uint8 Gr_over_Gb_golden_l;
	kal_uint8 info_checksum;
	kal_uint8 checksum_calc;
	kal_uint8 data_valid;
	kal_uint8 otp_ready;
};
