...
#ifdef CONFIG_LGE_PM
	int (*input_suspend)(struct charger_device *, bool en);
	int (*is_input_suspended)(struct charger_device *, bool *en);

	int (*set_recharge_voltage)(struct charger_device *, u32 uV);
	int (*get_recharge_voltage)(struct charger_device *, u32 *uV);

	int (*enable_ship_mode)(struct charger_device *, bool en);
	int (*is_ship_mode_enabled)(struct charger_device *, bool *en);
#endif
};
...
#ifdef CONFIG_LGE_PM
extern int charger_dev_input_suspend(struct charger_device *chg_dev, bool en);
extern int charger_dev_is_input_suspended(struct charger_device *chg_dev,
					bool *en);
extern int charger_dev_set_recharge_voltage(struct charger_device *chg_dev,
					u32 uV);
extern int charger_dev_get_recharge_voltage(struct charger_device *chg_dev,
					u32 *uV);
extern int charger_dev_enable_ship_mode(struct charger_device *chg_dev, bool en);
extern int charger_dev_is_ship_mode_enabled(struct charger_device *chg_dev,
					bool *en);
#endif
