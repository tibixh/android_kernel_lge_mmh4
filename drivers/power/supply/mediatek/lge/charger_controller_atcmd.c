...
#define CC_ATCMD_RW_PERM (S_IRUSR | S_IWUSR | S_IRGRP | S_IWGRP | S_IROTH)
#define CC_ATCMD_RO_PERM (S_IRUSR | S_IRGRP | S_IROTH)
#define CC_ATCMD_WO_PERM (S_IWUSR | S_IWGRP)
...
module_param_cb(atcmd_batmp, &atcmd_batmp, NULL, CC_ATCMD_RO_PERM);
...
module_param_cb(atcmd_charge, &atcmd_charge, NULL, CC_ATCMD_RW_PERM);
...
module_param_cb(atcmd_chcomp, &atcmd_chcomp, NULL, CC_ATCMD_RO_PERM);
...
module_param_cb(atcmd_chgmodeoff, &atcmd_chgmodeoff, NULL, CC_ATCMD_WO_PERM);
