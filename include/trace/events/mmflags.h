...
#define IF_HAVE_AREADAHEAD(flag,string) ,{1UL << flag, string}
#else
#define IF_HAVE_AREADAHEAD(flag,string)
#endif
...
IF_HAVE_AREADAHEAD(PG_r_readahead,	"random_readahead"	)	\
IF_HAVE_AREADAHEAD(PG_s_readahead,	"sequential_readahead"	) \
